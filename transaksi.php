                ...
                <div class="card card-primary card-outline card-tabs">
                    <div class="card-header p-0 pt-1 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">Riwayat Transaksi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Tambah Transaksi
                                    Masuk</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-three-messages-tab" data-toggle="pill" href="#custom-tabs-three-messages" role="tab" aria-controls="custom-tabs-three-messages" aria-selected="false">Tambah Transaksi
                                    Keluar</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="card card-primary">
                                    ...
                                    <form action="db/funcTransaksi.php" method="post">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="proses" value="masuk" class="btn btn-primary">Proses</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
                                ...
                                <div class="card card-primary">
                                    ...
                                    <form action="db/funcTransaksi.php" method="post">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Nama Barang</label>
                                                <select class="form-control select2" name="barang" id="barangid" required>
                                                    <option disabled selected value>Pilih Barang</option>
                                                    <?php
                                                    include_once 'koneksi.php';
                                                    $query = "select * from tblbarang";
                                        ...
                                        <!-- /.card-body -->
                                        <div class="card-footer">
                                            <button type="submit" class="btn btn-primary" name="proses" value="keluar">Proses</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
